module.exports = function (app) {
    ...
    app.get('/conversation', (req, res) => {
        ...
        MongoClient.connect(connectionString, (err, client) => {
            ...
            db.collection('conversation').find().toArray()
                .then(result => {
                    console.log(result)
                    res.json(result)
                })
    ...
    app.post('/conversation', (req, res) => {
        ...
        if (req.query['id']) {
            MongoClient.connect(connectionString, (err, client) => {
                ...
                db = client.db('ChickyCluster')
                db.collection('conversation').insertOne({
                    _id: req.query['id'],
                })
                    .then(result => {
                        console.log(result)
    ...
    app.get('/conversation', (req, res) => {
        ...
        if (req.query['id']) {
            MongoClient.connect(connectionString, (err, client) => {
                ...
                db = client.db('ChickyCluster')
                db.collection('conversation').findOneAndUpdate(
                    {
                        _id: req.query['id']
                    },
                    {
    ...
    app.get('/conversation', (req, res) => {
        ...
        if (req.query['id']) {
            MongoClient.connect(connectionString, (err, client) => {
                ...
                db = client.db('ChickyCluster')
                db.collection('conversation').deleteOne(
                    {
                        _id: req.query['id']
                    }
                )
